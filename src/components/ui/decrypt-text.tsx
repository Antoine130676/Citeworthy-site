...
/* eslint-disable react-hooks/set-state-in-effect, react-hooks/refs, react-hooks/immutability --
   Vendored as-is from Motiq (see attribution below); these rules flag deliberate patterns
   documented in the file's own comments (SSR-safe mount sync, latest-callback ref, the
   self-referencing rAF loop in `play`). Don't hand-edit vendor animation logic to satisfy them. */
